...
class ControllerAccountMyaccount extends Controller {
    ...
    public function index() {
        ...
        //if($cust_code=="fhd"){
        //    $this->redirect($this->url->link('account/myaccount2', '', 'SSL'));
        //}
        ...
        /*
         * $this->data['total_sale'] = $this->currency->format($this->model_account_myaccount->getTotalSales(), $this->config->get('config_currency'));
         * $this->data['total_sale_year'] = $this->currency->format($this->model_account_myaccount->getTotalSalesByYear(date('Y')), $this->config->get('config_currency'));
         * $this->data['total_order'] = $this->model_account_myaccount->getTotalOrders();
        ...
        $res = $this->model_account_myaccount->getProductOrders($data);
        ...
        $res2 = $orders_list;
        $this->data['department']=$this->model_account_myaccount->getSummary($data);
        ...
        //$this->data['chart'] = $this->model_account_myaccount->getChartData($data);
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/myaccount.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/account/myaccount.tpl';
        } else {
