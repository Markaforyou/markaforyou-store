    ...
    public function index() {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->data['simple_create_account'] && $this->validate()) {
            ...
            if ($this->customer->isLogged()) {
                ...
                $this->simple->save_custom_data(Simple::SET_REGISTRATION, Simple::OBJECT_TYPE_CUSTOMER, $customer_info['customer_id']);
                $this->simple->save_custom_data(Simple::SET_REGISTRATION, Simple::OBJECT_TYPE_ADDRESS, $customer_info['address_id']);
            }
